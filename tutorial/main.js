...
function send_info()
{
	...
	var rad_ld = $("#rad_ld").val();
	var b_speed = $("#b_speed").val();
	var min_b10 = $("#min_b10").val();
	var max_od = $("#max_od").val();
	var min_id = $("#min_id").val();
	var max_width = $("#max_width").val();
	// /width = 17.6126546

	var lsb = rad_ld*b_speed*min_b10;
	...
	$.ajax({
		...
		success: function(response, textStatus, xhr)
		{
			...
			else
			{
				...
				{
					//alert(value);
					localStorage.setItem("Demo-Data-" + key, value);
				});*/
